    ...
    Options.div
        ...
        [ Options.div
            ...
            [ Chip.span
                ...
                , Chip.deleteClick (lift <| Log "deleteClick")
                , Options.onClick (lift <| Log "onClick")
                ]
                [ Chip.content []
                    [ text <| model.translation.solvedBy False "ELT" ]
                ]
            , Chip.span
                [ Chip.deleteIcon "cancel"
                , Chip.deleteClick (lift <| Log "deleteClick")
                ...
                [ Chip.content []
                    [ text <| model.translation.solvedBy True "TheGoonies" ]
                ]
            , Chip.span
                [ Chip.deleteIcon "cancel"
                , Chip.deleteClick (lift <| Log "deleteClick")
                ...
                [ Chip.content []
                    [ text <| model.translation.inCategory True "xpl" ]
                ]
            ]
        , Options.div
            ...
            (List.range 0 5 |> List.map (Html.map lift << card model.challenges))
        ]
